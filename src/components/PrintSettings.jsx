  ...
  return (
    <button
      ...
      className={`
        ...
        ${active
          ? 'bg-[#F78C25] text-white glow-orange-sm'
    ...
    <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-2xl mx-auto px-4 py-4">
      ...
      <div className="bg-white border border-orange-100 rounded-2xl p-4 mb-6 flex items-center gap-4 shadow-sm">
        <div className="w-10 h-10 rounded-xl bg-orange-50 border border-orange-200 flex items-center justify-center flex-shrink-0">
          <svg className="w-5 h-5 text-[#F78C25]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="text-right flex-shrink-0">
          <p className="text-[#F78C25] font-bold text-lg">{fileInfo.totalPages}</p>
          <p className="text-gray-400 text-xs">pages</p>
        </div>
      </div>

      <h2 className="text-2xl font-bold text-[#222222] mb-6">Print Settings</h2>

      <div className="space-y-5">
        {/* Color Mode */}
        <div className="bg-white border border-orange-100 rounded-2xl p-5 shadow-sm">
          <p className="text-gray-500 text-sm font-medium mb-3">Print Type</p>
        ...
        {/* Side Mode */}
        <div className="bg-white border border-orange-100 rounded-2xl p-5 shadow-sm">
          <p className="text-gray-500 text-sm font-medium mb-3">Print Side</p>
          <div className="flex gap-3">
        ...
        {/* Copies */}
        <div className="bg-white border border-orange-100 rounded-2xl p-5 shadow-sm">
          <p className="text-gray-500 text-sm font-medium mb-3">Number of Copies</p>
